<template>
  <div class="container">
    <section class="row">
    <div class="offcanvas offcanvas-top theme-lightgray-bg text-light col-12" data-bs-backdrop="static" tabindex="-1" id="create-event-off-canvas" aria-labelledby="create-event-off-canvas">
  ...
  <div class="row justify-content-evenly">
    ...
    <div class="mb-2">
      ...
      <input v-model="editable.name" type="text" class="form-control" id="event-name" maxlength="50" required>
    </div>
    <div class="mb-2">
      <label for="event-location" class="form-label">Event Location:</label>
      <input v-model="editable.location" type="text" class="form-control" id="event-location" maxlength="30" required>
    </div>
    <div class="mb-2">
      <label class="control-label" for="event-date">Date</label>
      <VueDatePicker v-model="editable.startDate" required></VueDatePicker>
    </div>
    <div class="mb-2">
      <label for="event-capacity" class="form-label">Event Capacity:</label>
      <input v-model="editable.capacity" type="number" class="form-control" id="event-capacity" max="99999" required>
    </div>
    </div>
    <div class="col-8">
      <div class="mb-2">
      <label for="img-url" class="form-label">Image URL for the Event:</label>
      <input v-model="editable.coverImg" type="text" class="form-control" id="img-url" maxlength="300" required>
    </div>
      <div class="mb-2">
        <label for="event-description" class="form-label">Tell us about your event!</label>
        <textarea v-model="editable.description" type="text" class="form-control" id="event-description" maxlength="1000" minlength="5" required></textarea>
      </div>
